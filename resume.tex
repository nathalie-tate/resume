...
\begin{tabular}{b{4cm} c b{12cm}}
	\textbf{\huge Nathalie~Tate} & \hspace{14pt} & \parbox[b]{12cm}
    {
      \textbf{Shelby~Twp~MI} \\
        {
...
{%\large
  ...
  for local startup companies. Strong problem solver with a willingness to
  learn new technologies. Actively seeking software development opportunities.
}
...
\begin{itemize}\itemsep \listsep \small
    ...
    customers with delivery providers
    ...
    \resitem{Met with client to capture project requirements}
    \resitem{Provided guidance and training for Summer Intern}
\end{itemize}
